# Run this file for calculating the psychometrics of the best-fitted model for monkey dataset
...
driftcoh = 12.472275378654526
Sy = 2.021438287448084
Sx = 9.429291565840560
d = 0.511930299933043
sigma0 = 0.869972517459790
B = 1
nondectime = 0.257019414510056
ndsigma = 0.088209808489656
dx = .001
dt = .01
T_dur = 5
run_numbers = 1
model_2 = Model(name='monkey data, drift varies with coherence and urgency, noise with urgency',
...
model_1 = Model(name='monkey data, drift varies with urgency and coherence, noise with urgency and coherence',
                drift=DriftUrgencyGain(driftcoh=driftcoh,
                                       Sy=Sy,
                                       Sx=Sx,
                                       d=d),
...
model_3 = Model(name='monkey data, drift varies with coherence, noise with urgency',
...
model_4 = Model(name='monkey data, drift varies with coherence and urgency, noise',
                drift=DriftUrgencyGain(driftcoh=driftcoh,
                                       Sy=Sy,
                                       Sx=Sx,
                                       d=d),
...
model_coherence = []
model_meanRTerr = []
conditions = roitman_sample.condition_combinations()
solution = solve_all_conditions(model=model_1, sample=roitman_sample,
...
for comb in roitman_sample.condition_combinations():
    subsamples = roitman_sample.subset(**comb)

sample_accuracy = roitman_sample.prob("correct")
sample_meanRT = roitman_sample.mean_decision_time()
...
model_RT_parameters = [model_accuracy, model_meanRT, model_meanRTerr, model_pdfcorr, model_pdferr, model_coherence,
                       variable_names]
file_name = 'solved_model_1_LossRobustLikelihood.pkl'
